...
from salt.models.maskformer_loss_noreg import MaskFormerLossNoRegMatching
...
class MaskDecoderNoRegMatcher(nn.Module):
    ...
    def __init__(
        ...
        self.mask_loss = MaskFormerLossNoRegMatching(**loss_config, num_objects=num_objects)
